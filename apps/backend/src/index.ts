...
app.get("/api/users",middleware,getprofiledata)
app.put("/newpassword",middleware,changepassword)
app.put("/api/profile/update",middleware,updateprofiledata)
...
app.put("/api/leave/:id",middleware,updateLeaveStatus)
app.get("/api/payslip",middleware,getPaySlip)
