  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        {/* Orbs */}
        <div style={{ position: "absolute", top: "18%", left: "25%", width: 340, height: 340, borderRadius: "50%", background: "radial-gradient(circle, rgba(249,115,22,0.16) 0%, transparent 68%)", animation: "floatOrb 8s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "12%", right: "-50px", width: 220, height: 220, borderRadius: "50%", background: "radial-gradient(circle, rgba(249,115,22,0.09) 0%, transparent 70%)", animation: "floatOrb 11s 3s ease-in-out infinite", pointerEvents: "none" }} />
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
            ...
            <span style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.4)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Admin Access</span>
          </div>
          ...
          <h1 style={{ fontFamily:"Roboto, sans-serif", fontWeight: 800, fontSize: "clamp(4.8rem, 3vw, 2.6rem)", lineHeight: 1.1, color: "#fff", marginBottom: 18, letterSpacing: "-0.02em" }}>
            Admin<br />
            <span style={{ color: "#F97316" }}>Control </span>
            Panel
          </h1>

          <p style={{ fontSize: "0.88rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.8, maxWidth: 320, fontWeight: 300 }}>
            Secure administrator access to manage employees, payroll, attendance, and system settings.
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ position: "absolute", top: -60, right: -60, width: 200, height: 200, borderRadius: "50%", background: "radial-gradient(circle, rgba(249,115,22,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />

        <div style={{ width: "100%", maxWidth: 400 }}>

          {/* Back link */}
          <a href="/login" className="back-link" style={{ color:"white",display: "inline-flex", marginBottom: "15px"}}>
            ← Back to portals
          </a>

          {/* Heading */}
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "1.9rem", color: "#fff", marginBottom: 6, letterSpacing: "-0.01em" }}>
            Admin Sign In
          </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              />
              <label htmlFor="remember" style={{ fontSize: "0.82rem", color: "#555", cursor: "pointer" }}>
          ...
          {/* Footer */}
          <p style={{ marginTop: 40, fontSize: "0.72rem", color: "#2a2a2a", textAlign: "center" }}>
